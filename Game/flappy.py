...
PLAYERS_LIST = (
    ...
    (
        # amount by which base can maximum shift to left
        'Game/assets/sprites/bluebird-upflap.png',
        'Game/assets/sprites/bluebird-midflap.png',
        'Game/assets/sprites/bluebird-downflap.png',
    ),
    # yellow bird
    (
        'Game/assets/sprites/yellowbird-upflap.png',
        'Game/assets/sprites/yellowbird-midflap.png',
        'Game/assets/sprites/yellowbird-downflap.png',
    ),
)

# list of backgrounds
BACKGROUNDS_LIST = (
    'Game/assets/sprites/background-day.png',
    'Game/assets/sprites/background-night.png',
)

# list of pipes
PIPES_LIST = (
    'Game/assets/sprites/pipe-green.png',
    'Game/assets/sprites/pipe-red.png',
)
...
def main():
    ...
    # game over sprite
    IMAGES['gameover'] = pygame.image.load('Game/assets/sprites/gameover.png').convert_alpha()
    # message sprite for welcome screen
    IMAGES['message'] = pygame.image.load('Game/assets/sprites/message.png').convert_alpha()
    # base (ground) sprite
