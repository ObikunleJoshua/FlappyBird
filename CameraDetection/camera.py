...
template_list=list()
template_list.append(cv2.imread('CameraDetection/template_1.png')) #Load the image
template_list.append(cv2.imread('CameraDetection/template_2.png')) #Load the image
 # template_list.append(cv2.imread('CameraDetection/template_3.png')) #Load the image
template_list.append(cv2.imread('CameraDetection/template_4.png')) #Load the image
template_list.append(cv2.imread('CameraDetection/template_5.png')) #Load the image
#template_list.append(cv2.imread('CameraDetection/template_6.png')) #Load the image
...
while(True):
    ...
    cv2.imshow('josh - deepgaze', frame) #show on window
